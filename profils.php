...
$req2 = $BDD->prepare("SELECT *
                            FROM relation
                            WHERE id_demandeur = ? AND id_receveur = ? AND statut = 3");
$req2->execute(array($id_receveur,$id_demandeur));


$vousabloq = $req2->fetchAll();


$okvousabloquer = false;
if(isset($vousabloq['id_demandeur'])) {
    $okvousabloquer = true;
      echo '-111';
}
// VOUS LAVEZ LBOQUER
$req2 = $BDD->prepare("SELECT *
                            FROM relation
                     WHERE id_demandeur = ? AND  id_receveur = ? AND  statut = 3");
$req2->execute(array($id_demandeur,$id_receveur));



$vouslaverabloq = $req2->fetch();
var_dump($vouslaverabloq);
print_r($vouslaverabloq);
$okvouslavezbloquer = false;
if(isset($vousabloq['id_demandeur'])) {
    $okvouslavezbloquer = true;
    echo '-222';
}
    ...
    <body>
        ...
        <div class="container">
            ...
            echo '//**'.$id_demandeur.'-'. $id_receveur.'//';*/
                            ...
                            if($okvouslavezbloquer){
                                echo "Vous avez bloqué ce compte";
        ...
        <div id="resultcontent"  class="pt-3 pb-3 d-flex shadow-sm rounded h-100    bg-primary" >
            ...
            <div class=" container-fluid ligneCardMusic">
                ...
                if($okvousabloquer && $okvouslavezbloquer){ 
